...
export default function SiteFooter() {
  return (
    <footer className="text-center py-8 border-t border-[#fde8c4] mt-4 bg-white">
      ...
      <a
        href="https://www.instagram.com/getbrewscanner/"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-1.5 text-[11px] text-stone-400 hover:text-[#B34207] transition-colors mb-3"
      >
